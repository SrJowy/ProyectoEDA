...
public class MapaWebs {
    ...
    public void eliminarDeListaEnlazadas(Web pWeb) {
        for (int i = 0; i < this.getTamaino(); i++) {
            if (this.lW.get(i).getListaEnlazadas().contains(pWeb)) {
                this.lW.get(i).borrarDeListaEnlazadas(pWeb);
            }
        }
    }
